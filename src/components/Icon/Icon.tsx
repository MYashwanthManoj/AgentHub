/**
 * Icon.tsx — lightweight stroke-based icon system.
 *
 * Dependency-free: every icon is an inline SVG path (24×24 viewBox,
 * currentColor stroke) so there are no extra packages to install.
 * All icons render at the same visual weight for a consistent, technical
 * enterprise aesthetic. Sizes: 16 (inline) / 20 (list items) / 24 (nav).
 */
...
export type IconName =
  ...
  | 'registry' // layered boxes
  | 'transactions' // left-right arrows
  | 'analytics' // rising bars
  | 'playground' // terminal
  | 'keys' // key
  | 'webhooks' // linked nodes / antenna
  | 'docs' // book
  | 'wallet' // wallet
  | 'settings' // gear
  | 'automations' // workflow / repeat
  | 'search'
  | 'copy'
  | 'check'
  | 'x'
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  alert: (
    <>
      <path d="m10.29 3.86-8.3 14.06a2 2 0 0 0 1.71 3h16.6a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0Z" />
      <path d="M12 9v4" />
      <path d="M12 17h.01" />
    </>
  ),
  ...
  flag: (
    <>
      <path d="M4 22V4a1 1 0 0 1 1-1h9.5a1 1 0 0 1 .9 1.5L14 7l1.4 2.5a1 1 0 0 1-.9 1.5H5" />
    </>
  ),
  star: (
...
/** Icon — stroke-based SVG icon at a consistent weight. */
